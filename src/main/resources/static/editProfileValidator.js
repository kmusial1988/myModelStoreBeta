function validateData(){
    ...
    var surname = document.forms["dataForm"]["surname"].value;
     ...
     if(!regex.test(name)){
             document.forms["dataForm"]["name"].style.background = "#f2d9e6";
             flag = false;
         }else{
             document.forms["dataForm"]["name"].style.background = "white";
         }
         if(!regex.test(surname)){
             document.forms["dataForm"]["surname"].style.background = "#f2d9e6";
             flag = false;
         }else{
...
function validatePass(){
    ...
    var newPass2 = document.forms["passForm"]["newPass2"].value;
     ...
     if(!regex.test(currentPass)){
             document.forms["passForm"]["currentPass"].style.background = "#f2d9e6";
             flag = false;
         }else{
             document.forms["passForm"]["currentPass"].style.background = "white";
         }
         if(!regex.test(newPass)){
             document.forms["passForm"]["newPass"].style.background = "#f2d9e6";
             flag = false;
         }else{
             document.forms["passForm"]["newPass"].style.background = "white";
         }
         if(newPass != newPass2){
             document.forms["passForm"]["newPass2"].style.background = "#f2d9e6";
             flag = false;
         }else{
